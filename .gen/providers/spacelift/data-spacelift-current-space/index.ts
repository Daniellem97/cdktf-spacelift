// https://registry.terraform.io/providers/spacelift-io/spacelift/1.27.0/docs/data-sources/current_space
...
export interface DataSpaceliftCurrentSpaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.27.0/docs/data-sources/current_space#id DataSpaceliftCurrentSpace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.27.0/docs/data-sources/current_space spacelift_current_space}
*/
export class DataSpaceliftCurrentSpace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftCurrentSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.27.0/docs/data-sources/current_space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.27.0/docs/data-sources/current_space spacelift_current_space} Data Source
  *
  * @param scope The scope in which to define this construct
